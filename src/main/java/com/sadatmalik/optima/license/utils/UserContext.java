...
public class UserContext {
    ...
    private static final ThreadLocal<String> organisationId = new ThreadLocal<>();
    ...
    public static void setOrganisationId(String organisation) {
        organisationId.set(organisation);
    }
